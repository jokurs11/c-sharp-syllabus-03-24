...
namespace Excercise5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string class5 = "Principles of Technology I5555";
            ...
            Console.WriteLine("| 1 | {0,-36} | {1,-15} |", class1, teacher1);
            Console.WriteLine("| 2 | {0,-36} | {1,-15} |", class2, teacher2);
            Console.WriteLine("| 3 | {0,-36} | {1,-15} |", class3, teacher3);
            Console.WriteLine("| 4 | {0,-36} | {1,-15} |", class4, teacher4);
            Console.WriteLine("| 5 | {0,-36} | {1,-15} |", class5, teacher5);
            Console.WriteLine("| 6 | {0,-36} | {1,-15} |", class6, teacher6);
            Console.WriteLine("| 7 | {0,-36} | {1,-15} |", class7, teacher7);
            Console.WriteLine("| 8 | {0,-36} | {1,-15} |", class8, teacher8);
